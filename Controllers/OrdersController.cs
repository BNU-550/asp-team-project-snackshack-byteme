...
namespace Snack_Shack.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PersonID"] = new SelectList(_context.People, "PersonID", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderID,PersonID,PaymentID,StaffName,TableNo,OrderDate")] Order order)
        {
            ...
            ViewData["PersonID"] = new SelectList(_context.People, "PersonID", "Discriminator", order.PersonID);
            return View(order);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,PersonID,PaymentID,StaffName,TableNo,OrderDate")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
